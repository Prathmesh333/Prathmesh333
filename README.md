...
![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&pause=1000&color=36BCF7&center=true&vCenter=true&random=false&width=600&lines=M.Tech+Student+%40+University+of+Hyderabad;Machine+Learning+Engineer;Full+Stack+Developer;Open+Source+Enthusiast)
...
- Byzantine fault tolerance & MapReduce aggregation
...
Advanced MoE system orchestrating specialized AI agents for consensus-based responses.
...
Built using GradientBoostingRegressor with feature engineering from Ergast F1 API.
...
Processes audio, video, images via Whisper & Google Vision OCR.
- 10+ language support
